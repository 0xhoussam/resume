...
Software Engineer with hands-on experience in scalable backend systems, networking, and full-stack development. Skilled in C/C++, Go, JavaScript/TypeScript, and SQL. Experienced in building HTTP servers, chat platforms, and Unix tools, with strong proficiency in Docker, Git, and Linux.
...
- Designed and deployed scalable backend services, integrating blob storage and real-time chat features. Improved data management efficiency and user experience through optimized database architectures and server deployments.
...
== Skills
- *Backend*: Go, C/C++, TypeScript/JavaScript, SQL, Express, NGINX, Caddy, Postgres
